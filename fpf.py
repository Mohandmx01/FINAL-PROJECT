...
#--------------------------------------------------------------addbar-------------------------
icon = Image.open("C:/Users/Mohan.S/Desktop/Mohan_Project/Final_project/1.png")
...
def page4():
    ...
    selected_num_interactions = st.selectbox('ELECT NUM INTERACTIONS', options=num_interactions_options)
    selected_avg_session_time = st.selectbox('SELECT AVG SESSION TIME', options=avg_session_time_options)
    selected_sessionQualityDim = st.selectbox('SELECT SESSION QUALITY DIM:', options=sessionQualityDim_options)
...
def page6():
    ...
    user_text = st.text_area("Enter your text:", "Mohan.S Aspiring a Data Scientist...")
